...
def get_vector_flag():
  # Get the closest flag id
  closest_flag_id = game.functions.nearest_object("flags") # Default: type = "bot"
  #game.functions.print("Closest flag id: " + str(closest_flag_id))
  ...
  if closest_flag_id is not None:
    ...
    #game.functions.print("Flag position: " + str(x) + ", " + str(y))
    ...
    if zones_ids is not None:
        ...
        for zone_id in zones_ids:
            if game.functions.get_attribute(zone_id, "zones", "owner") == my_id:
                ...
                #game.functions.print("Zone position: " + str(x) + ", " + str(y))
...
if not flag_in_my_zone():
    carrying_flag = game.functions.get_attribute(None, "me", "carrying_flag") is not None
